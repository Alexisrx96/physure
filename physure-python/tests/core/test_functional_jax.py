...
from physure.backends.jax_backend import JaxBackend, register_jax_behavior
from physure.functional import FunctionalState, add
...
def test_jax_functional_add_jit_execution():
    ...
    from physure.functional import register_functional_pytree
