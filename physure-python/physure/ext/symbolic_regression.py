...
programming over `physure.domain.symbolic.native` expression trees,
...
from physure.domain.symbolic.native import Quantity as _QuantityNode

if TYPE_CHECKING:
    from physure.domain.measurement.quantity import Quantity
    from physure.domain.symbolic.native import Node
