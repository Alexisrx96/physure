...
| **3. Chemistry & Reaction Tracking** | 🚧 Python ✅ / Rust+PHS Planned | 50% | [Chemistry Roadmap](docs/chemistry_roadmap.md) | `physure.ext.chemistry` → `physure_core::chemistry` + PHS builtins |
| **4. Symbolic Math & CAS Engine** | 🚧 Phase 1 Done / Phase 2–4 In Progress | 35% | [Symbolic Math Roadmap](docs/symbolic_math_roadmap.md) | `physure_core::cas`, Gröbner, Risch, ODEs, SAT |
...
1. 🧮 **[Symbolic Math & Advanced CAS Engine Roadmap](docs/symbolic_math_roadmap.md)**
   ...
   * Companion research: **[Symbolic Math Scientific Research](docs/symbolic_math_research.md)**.

2. 🧪 **[Chemistry & Physical-Chemical Reaction Tracking Roadmap](docs/chemistry_roadmap.md)**
...
3. 📐 **[Parametric Physical & Scientific Diagramming Engine Roadmap](docs/diagrams_roadmap.md)**
...
4. 🔬 **[Scientific Companion & Metrology Roadmap](docs/scientific_roadmap.md)**
...
5. ⚖️ **[Scientific Gaps, Metrological Rigor & Reality Analysis](docs/scientific_gaps_and_rigor.md)**
...
timeline
    ...
    Q3 2026 (Completed) : Rust Core Engine : Correlated Uncertainty & Covariance : Chemistry Python Extension (Species & Reactions) : Native Symbolic AST & Regression
    Q4 2026 (In Progress) : Multivariate Polynomials & Gröbner Bases (F4/F5) : Rust Core Chemistry Module (physure_core::chemistry) : Risch Integration Engine : Buckingham Pi Nullspace Solver
    Q1 2027 (Planned) : PHS DSL Chemistry Builtins : Analytical ODE/PDE Solvers (dsolve/pdesolve) : Parametric Free-Body Diagrams (physure.diagrams) : GUM Welch-Satterthwaite & Real Gas EOS
    Q2 2027 (Planned) : Advanced Reaction Networks & Equilibrium : Cross-Language Chemistry Bindings : Verified Interval Arithmetic (IEEE 1788) : DPLL SAT Solver & Noether Symmetries
```
...
2. **Relative Linking**: All documentation links MUST remain relative (e.g. `docs/symbolic_math_roadmap.md`) to guarantee portability across GitHub, MkDocs, and local clones.
3. **Paper Citations**: Any new algorithm or physical model added to the roadmap must include peer-reviewed scientific paper citations with public DOI/web links in [`docs/symbolic_math_research.md`](docs/symbolic_math_research.md) or [`docs/scientific_gaps_and_rigor.md`](docs/scientific_gaps_and_rigor.md).
