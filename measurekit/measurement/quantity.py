"""Quantity class for representing physical quantities."""
...
class Quantity(Generic[ValueType, UncType]):
    """
    Represents a physical quantity with magnitude, unit, uncertainty,
    and an associated unit system.
    """
    ...
    dimension: Dimension
    # THIS IS THE OTHER PART OF THE FIX: Use a string forward reference.
    system: "UnitSystem"
    ...
    def from_input(
        ...
        """Primary factory method for creating Quantity instances."""
